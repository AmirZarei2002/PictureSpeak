...
mixin _$AnalyticsOverview {
 ...
 int get totalUsers; int get guestUsers; int get registeredUsers; int get totalAdmins; int get totalCategories; int get activeCategories; int get totalItems; int get activeItems; int get totalProgressRows;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,totalUsers,guestUsers,registeredUsers,totalAdmins,totalCategories,activeCategories,totalItems,activeItems,totalProgressRows);

@override
String toString() {
  return 'AnalyticsOverview(totalUsers: $totalUsers, guestUsers: $guestUsers, registeredUsers: $registeredUsers, totalAdmins: $totalAdmins, totalCategories: $totalCategories, activeCategories: $activeCategories, totalItems: $totalItems, activeItems: $activeItems, totalProgressRows: $totalProgressRows)';
}
...
@useResult
$Res call({
 int totalUsers, int guestUsers, int registeredUsers, int totalAdmins, int totalCategories, int activeCategories, int totalItems, int activeItems, int totalProgressRows
});
...
/// Create a copy of AnalyticsOverview
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalUsers = null,Object? guestUsers = null,Object? registeredUsers = null,Object? totalAdmins = null,Object? totalCategories = null,Object? activeCategories = null,Object? totalItems = null,Object? activeItems = null,Object? totalProgressRows = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalUsers,  int guestUsers,  int registeredUsers,  int totalAdmins,  int totalCategories,  int activeCategories,  int totalItems,  int activeItems,  int totalProgressRows)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AnalyticsOverview() when $default != null:
return $default(_that.totalUsers,_that.guestUsers,_that.registeredUsers,_that.totalAdmins,_that.totalCategories,_that.activeCategories,_that.totalItems,_that.activeItems,_that.totalProgressRows);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalUsers,  int guestUsers,  int registeredUsers,  int totalAdmins,  int totalCategories,  int activeCategories,  int totalItems,  int activeItems,  int totalProgressRows)  $default,) {final _that = this;
switch (_that) {
case _AnalyticsOverview():
return $default(_that.totalUsers,_that.guestUsers,_that.registeredUsers,_that.totalAdmins,_that.totalCategories,_that.activeCategories,_that.totalItems,_that.activeItems,_that.totalProgressRows);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalUsers,  int guestUsers,  int registeredUsers,  int totalAdmins,  int totalCategories,  int activeCategories,  int totalItems,  int activeItems,  int totalProgressRows)?  $default,) {final _that = this;
switch (_that) {
case _AnalyticsOverview() when $default != null:
return $default(_that.totalUsers,_that.guestUsers,_that.registeredUsers,_that.totalAdmins,_that.totalCategories,_that.activeCategories,_that.totalItems,_that.activeItems,_that.totalProgressRows);case _:
  return null;
...
class _AnalyticsOverview implements AnalyticsOverview {
  const _AnalyticsOverview({required this.totalUsers, required this.guestUsers, required this.registeredUsers, required this.totalAdmins, required this.totalCategories, required this.activeCategories, required this.totalItems, required this.activeItems, required this.totalProgressRows});
...
/// Create a copy of AnalyticsOverview
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalUsers = null,Object? guestUsers = null,Object? registeredUsers = null,Object? totalAdmins = null,Object? totalCategories = null,Object? activeCategories = null,Object? totalItems = null,Object? activeItems = null,Object? totalProgressRows = null,}) {
